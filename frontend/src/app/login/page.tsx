        ...
        >
          ...
          {!mounted ? (
            <div className="flex flex-col items-center gap-8 py-10">
              <div className="w-24 h-24 bg-moss-50 rounded-full flex items-center justify-center mb-2 animate-pulse"></div>
              <div className="h-4 w-3/4 bg-moss-50 rounded animate-pulse"></div>
              <div className="h-10 w-full bg-moss-50 rounded-xl animate-pulse"></div>
            </div>
          ) : (
            <>
              {/* Login Method Toggle */}
              <div className="flex w-full p-1 bg-moss-50 rounded-xl mb-8">
                <button
                  ...
                  className={`flex-1 py-2 px-2 text-xs sm:text-sm font-bold rounded-lg transition-all whitespace-nowrap ${loginMethod === 'traditional' ? 'bg-white text-moss-800 shadow-sm border border-moss-200/50' : 'text-moss-500 hover:text-moss-700'}`}
                >
                  Email & Password
                </button>
                <button
                  onClick={() => { setLoginMethod('web3'); setError(''); }}
                  className={`flex-1 py-2 px-2 text-xs sm:text-sm font-bold rounded-lg transition-all whitespace-nowrap ${loginMethod === 'web3' ? 'bg-white text-moss-800 shadow-sm border border-moss-200/50' : 'text-moss-500 hover:text-moss-700'}`}
                >
                  Web3 Wallet
                </button>
              </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input 
                        ...
                        placeholder="••••••••"
                        className="w-full pl-4 pr-12 py-3 border border-moss-200 rounded-xl focus:ring-2 focus:ring-olive-500 outline-none transition-all"
                      />
                      <button
                        type="button"
                ...
                !isConnected ? (
                  <div className="flex flex-col items-center gap-8 py-4">
                    ...
                    <button 
                      ...
                      className="py-3 px-6 bg-moss-600 text-white font-bold rounded-xl hover:bg-moss-700 transition-all shadow-md"
                    >
                      Connect MetaMask
                    </button>
                  </div>
